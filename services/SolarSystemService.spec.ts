...
describe("SolarSystemService", () => {
  ...
  it("should create a planet", () => {
    ...
    solarSystemService.createPlanet(planetName, radius, distanceToSun);
  ...
  it("should throw an error for invalid planet data", () => {
    ...
    expect(() => {
      solarSystemService.createPlanet(name, radius, distanceToSun);
  ...
  it("should not allow updating a non-existent planet", () => {
    ...
    expect(() =>
      solarSystemService.updatePlanet(planetName, radius, distanceToSun)
